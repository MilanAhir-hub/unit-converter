...
const newTranslations = {
  ...
  'gigabyte': {
    ...
    'ur': 'گیگا بائٹ', 'fa': 'گیگابایت', 'tl': 'Gigabyte'
  },
  'terabyte': {
  ...
  'binary': {
    ...
    'ms': 'Perduaan', 'bn': '바이নারি', 'ta': 'இருநிலை', 'te': 'బైనరీ', 'mr': 'बायनरी', 'gu': 'બાયનરી', 'pa': 'ਬਾਇਨਰੀ',
  ...
  'decimal': {
    ...
    'ms': 'Perpuluhan', 'bn': 'দশমিক', 'ta': 'தசம', 'te': 'దశాంశ', 'mr': 'दशांश', 'gu': 'દશાંશ', 'pa': 'ਦਸ਼ਮलਵ',
